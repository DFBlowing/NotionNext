...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://df-sharings.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一名普通的大学牲🐂', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.xiaoyuezhou.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '学习笔记, 博客', // 网站关键词 英文逗号隔开
